window.TextureRegistry = class {
    ...
    queueTextures() {
        ...
        this.updateProgress("TT ISS Tracker is preparing the textures", 0);
    }
    ...
    async loadNextTextureInQueue() {
        ...
        if (length <= 0) {
            ...
            this.updateProgress("Sit tight, crew! We are ready for blastoff!", startProgress);
            ...
            this.satelliteTracker.textureLoader.load(path,
                ...
                function (onError) {
                    scope.state = "TT ISS Tracker has failed to load texture: " + key;
                    scope.loadNextTextureInQueue();
                });
        }
    }
